...
void	load_textures(t_data *data)
{
	...
	data->north_texture.img = mlx_xpm_file_to_image(data->mlx_ptr,
			data->config->north_texture, &data->north_texture.width,
			&data->north_texture.height);
	data->north_texture.data = (int *)mlx_get_data_addr(data->north_texture.img,
			&bpp, &size_line, &endian);
	data->south_texture.img = mlx_xpm_file_to_image(data->mlx_ptr,
			data->config->south_texture, &data->south_texture.width,
			&data->south_texture.height);
	data->south_texture.data = (int *)mlx_get_data_addr(data->south_texture.img,
			&bpp, &size_line, &endian);
	data->west_texture.img = mlx_xpm_file_to_image(data->mlx_ptr,
			data->config->west_texture, &data->west_texture.width,
			&data->west_texture.height);
	data->west_texture.data = (int *)mlx_get_data_addr(data->west_texture.img,
			&bpp, &size_line, &endian);
	data->east_texture.img = mlx_xpm_file_to_image(data->mlx_ptr,
			data->config->east_texture, &data->east_texture.width,
			&data->east_texture.height);
	data->east_texture.data = (int *)mlx_get_data_addr(data->east_texture.img,
			&bpp, &size_line, &endian);
