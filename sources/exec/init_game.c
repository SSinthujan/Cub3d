...
void load_textures(t_data *data)
{
    ...
    data->north_texture.img = mlx_xpm_file_to_image(data->mlx_ptr, &data->north_texture.name,
    ...
    data->south_texture.img = mlx_xpm_file_to_image(data->mlx_ptr, &data->south_texture.name,
    ...
    data->west_texture.img = mlx_xpm_file_to_image(data->mlx_ptr, &data->west_texture.name,
    ...
    data->east_texture.img = mlx_xpm_file_to_image(data->mlx_ptr, &data->east_texture.name,
        ...
        !data->west_texture.img || !data->east_texture.img)
    {
        ...
        exit(1); // a chan,ger par free all S
    }
}
